#!/usr/bin/env python2
# Output Multiline Text - adjacent string literals concatenate
#  automatically with no operator needed (see a20.output.py for the
#  alternate triple-quote technique).
print (
