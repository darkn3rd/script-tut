...
if __FILE__ == $PROGRAM_NAME
  ...
  OptionParser.new do |opts|
    ...
    # See resolve_order.rb's own tag_eligible?/resolve_included (issue
  ...
  # Snapshotted before topological_order mutates steps' own order - see
  #  write_install_script's own comment on why. Also before
  #  resolve_included - a tag-filtered `steps` may not include every
  #  natural-order sibling relocate_cross_cutting's own prefix walk
  #  looks for.
  natural_steps = steps.dup
  steps, omitted = resolve_included(steps, options[:select], options[:exclude])
